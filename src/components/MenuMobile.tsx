    ...
    <div className="flex gap-10 items-center">
      ...
      <div className="space-y-5">
        ...
        <div className="text-center">
          <div className="flex justify-center">
            <button className="btn btn-sm btn-circle">
              <svg className="fill-current w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div className="text-center">
          <div className="flex justify-center">
            <button className="btn btn-sm btn-circle">
              <svg className="stroke-current w-6" viewBox="-0.5 0 25 25" fill="none">
                <path
      ...
      {/* Menu */}
      <div>
        <button className="btn btn-sm btn-circle bg-[#ffdb80] border-0">

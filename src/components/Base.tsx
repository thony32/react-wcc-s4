          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-5">
              ...
              <div className="col-span-4">
                <button
                  onClick={handleBuy}
                  className="bg-[#151515] hover:ring hover:ring-[#151515] hover:ring-offset-2 active:scale-105 p-5 rounded-full duration-150 flex items-center gap-5 w-1/2 group cursor-pointer"
                >
